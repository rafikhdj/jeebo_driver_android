...
import java.util.List;
    ...
    public class AdapterOrderInProcess extends RecyclerView.Adapter<AdapterOrderInProcess.CustomViewHolder> {
        private BaseActivity mContext;
        private List<OrderListResult> orderList;
        private ItemClickListener itemClickListener;
        private String address;

        public AdapterOrderInProcess(BaseActivity context, List<OrderListResult> orderList,ItemClickListener itemClickListener) {
        ...
        public int getItemViewType(int position) {
            return R.layout.inflater_order_process;
        }
